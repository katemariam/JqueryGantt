...
<html lang="en-au">
	...
	<div id="content">
		<div class="row">
			...
			<div class="col-md-6" style="padding:0px;">
				<select name="employee_name" id="employee_name" class="bot small-select" onchange="changeEmployee(this)">
				...
				<input class="bot" id="empHrs" type="text" size="5" value="2"/>	
        			 <br>

				<input class="small-date bot" type="date" id='stDate'><br>
				<input class="small-date bot" type="date" id='enDate'><br>
			</div>
		</div> 
		<br>
		<div class="row">
			<div class="col-md-6" style="padding-right:0px; margin-top: -10px;">
				...
				<button type="button" class="btn btn-danger btn-sm small-btn close">Cancel</button>
			</div>
    ...
    function changeEmployee(elem) {
    	var emp_id = elem.value

    	$.ajax({
    		url: "../tests/fetchEmployeehrs.php",
    		method: "post",
    		data: "id=" + emp_id,
			...
			/* 	$(".gantt").gantt({
				...
				$(".gantt").gantt({
					...
					onItemClick: function(data) {
						...
						$('#stDate').val(data.start);
						$('#enDate').val(data.end);
						$('#taskpop').val(data.name);
						...
						$(".bar").webuiPopover({
                            ...
                            '<p style="margin:0px; font-size: 14px" id="taskpop"></p>',
